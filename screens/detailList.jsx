...
export default function DetaiList({ route, navigation }){
                ...
                {isLoading ? (
                    ...
                    <View style={{flex: 1, width: '100%', justifyContent: 'center', alignItems: 'center', paddingBottom: 10}}>
                        ...
                        <View style={styles.row}>
                            <TouchableOpacity style={{width: '50%'}} onPress={() => {navigation.navigate('Follow', { type: 'following', userName: data.login })}}>
                                <View>
                            ...
                            <TouchableOpacity style={{width: '50%'}} onPress={() => {navigation.navigate('Follow', { type: 'followers', userName: data.login })}}>
                                <View>
